				...
				jbtOK.addActionListener(new ActionListener()  { // add the listener to the jbutton to handle the "pressed" event
				    public void actionPerformed(ActionEvent e) {
				        while (true) {
				        	...
				        	// makes message dialog boxes forever one after the other one by one after the ok button and/or X(cancel/close) is pressed
				        	...
				        	//JOptionPane.showMessageDialog(frame, "SURPRISE! TRY TO GET OUT NOW!!!", "Surprise Error!", JOptionPane.ERROR_MESSAGE);
				        	//JOptionPane.showMessageDialog(null, "SURPRISE! TRY TO GET OUT NOW!!!");
				        	//JOptionPane.showMessageDialog(null, "SURPRSE! TRY TO GET OUT NOW!!!");
				        	//JOptionPane.showMessageDialog(null, "SURPRISE! TRY TO GET OUT NOW!!!");
				        } //
				    }
				});
